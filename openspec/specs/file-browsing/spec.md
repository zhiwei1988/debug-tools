# file-browsing Specification

## Purpose

The file-browsing capability defines the File Browser page behavior — directory listing rendering, navigation, and the hidden-file visibility toggle. The HTTP listing endpoint itself continues to return all entries unfiltered; visibility is a client-side concern.
